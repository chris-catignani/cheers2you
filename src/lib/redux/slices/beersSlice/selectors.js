...
export const selectAreBeersSpinning = (state) => state.beers.areBeersSpinning;
...
export const selectUploadSocialMediaStatus = (state) => state.beers.uploadSocialMediaStatus;
export const selectUploadedSocialMediaData = (state) => state.beers.uploadedSocialMediaData;
